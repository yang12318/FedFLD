...
class ResNet(nn.Module):
    ...
    def _forward_impl(self, x: Tensor, flag: bool, flag_2: bool) -> Tensor:
    ...
    def forward(self, x: Tensor, flag: bool = False, flag_2: bool = False) -> Tensor:
        return self._forward_impl(x, flag, flag_2)


def customized_resnet18(pretrained: bool = False, progress: bool = True, num_classes: int = 10) -> ResNet:
    ...
    res18.fc = nn.Linear(512, num_classes)

    # Change BN to GN
    res18.bn1 = nn.GroupNorm(num_groups=2, num_channels=64)

    res18.layer1[0].bn1 = nn.GroupNorm(num_groups=2, num_channels=64)
    res18.layer1[0].bn2 = nn.GroupNorm(num_groups=2, num_channels=64)
    res18.layer1[1].bn1 = nn.GroupNorm(num_groups=2, num_channels=64)
    res18.layer1[1].bn2 = nn.GroupNorm(num_groups=2, num_channels=64)

    res18.layer2[0].bn1 = nn.GroupNorm(num_groups=2, num_channels=128)
    res18.layer2[0].bn2 = nn.GroupNorm(num_groups=2, num_channels=128)
    res18.layer2[0].downsample[1] = nn.GroupNorm(num_groups=2, num_channels=128)
    res18.layer2[1].bn1 = nn.GroupNorm(num_groups=2, num_channels=128)
    res18.layer2[1].bn2 = nn.GroupNorm(num_groups=2, num_channels=128)

    res18.layer3[0].bn1 = nn.GroupNorm(num_groups=2, num_channels=256)
    res18.layer3[0].bn2 = nn.GroupNorm(num_groups=2, num_channels=256)
    res18.layer3[0].downsample[1] = nn.GroupNorm(num_groups=2, num_channels=256)
    res18.layer3[1].bn1 = nn.GroupNorm(num_groups=2, num_channels=256)
    res18.layer3[1].bn2 = nn.GroupNorm(num_groups=2, num_channels=256)

    res18.layer4[0].bn1 = nn.GroupNorm(num_groups=2, num_channels=512)
    res18.layer4[0].bn2 = nn.GroupNorm(num_groups=2, num_channels=512)
    res18.layer4[0].downsample[1] = nn.GroupNorm(num_groups=2, num_channels=512)
    res18.layer4[1].bn1 = nn.GroupNorm(num_groups=2, num_channels=512)
    res18.layer4[1].bn2 = nn.GroupNorm(num_groups=2, num_channels=512)
...
def resnet18(pretrained: bool = False, progress: bool = True, group_norm=False, group_channels=0, **kwargs: Any):
    norm_layer = None
